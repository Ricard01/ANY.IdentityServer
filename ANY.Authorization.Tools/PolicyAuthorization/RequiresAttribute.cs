// Copyright (c) 2021 Joao Grassi https://blog.joaograssi.com/posts/2021/asp-net-core-protecting-api-endpoints-with-dynamic-policies/#authorize-attribute
...
public class RequiresAttribute : AuthorizeAttribute
{
    ...
    /// 
    public RequiresAttribute(PermissionOperator permissionOperator, params Permissions[] permissions) : base(permissions.ToString() ?? string.Empty)
    {
